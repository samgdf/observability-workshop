...
You took the workshop [Monitoring Agentic AI Applications](https://splunk.github.io/observability-workshop/en/ninja-workshops/ai/1-agentic-ai/) multi-agent travel planner and instrumented it with Splunk Agent Observability by adding just
...
workshop [Monitoring Agentic AI Applications](https://splunk.github.io/observability-workshop/en/ninja-workshops/ai/1-agentic-ai/), and Splunk Agent Observability here), which is a useful basis for comparison. What does Agent Observability show you that Observability Cloud doesn't, and vice versa?
